...
function mapResulRecords(result, requestQuery) {
    let aggregation = {
        ...
        count: requestParser.parseSeletor(requestQuery.count).concat(
        requestParser.parseSeletor(requestQuery.countDistinct))
    };
...
module.exports = { mapResulRecords, mapResultMetadata };
