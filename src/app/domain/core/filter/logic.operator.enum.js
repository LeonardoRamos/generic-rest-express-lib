...
LogicOperator.isOrOperator = (logicOperator) => {
	return (
		LogicOperator.OR.operator.toUpperCase() === logicOperator.toUpperCase() ||
...
LogicOperator.isAndOperator = (logicOperator) => {
	return (
		LogicOperator.AND.operator.toUpperCase() === logicOperator.toUpperCase() ||
